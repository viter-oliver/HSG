...
void unreferenced_items::search_unreferenced_items()
{
	...
	search_unref_items(g_vg_shader_list, _shader_list);
	search_unref_items(g_primitive_list, _primitive_list);
	search_unref_items(g_dic_file_chunk, _file_list);
	search_unref_items(g_dic_indep_texture, _txt_list);
}
...
void unreferenced_items::show_delete_unreferenced_items()
{
	...
	if (ImGui::Button("Ok"))
	{
		...
		delete_unref_items(g_vg_shader_list, _shader_list);
		delete_unref_items(g_primitive_list, _primitive_list);
		delete_unref_items(g_dic_file_chunk, _file_list);
		delete_unref_items(g_dic_indep_texture, _txt_list);
