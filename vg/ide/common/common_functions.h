...
extern void saveTextureToFile(GLuint textureID, const char *filename);
extern bool prepareFBO1(GLuint &colorTextId, GLuint &depthStencilTextId,
                        GLuint &fboId, GLuint frame_width, GLuint frame_height);
extern bool prepareFBO_ex(GLuint &texture_id,GLuint& FBO_id,GLuint& RBO_id,GLuint frame_width,GLuint frame_height);
extern void rescale_framebufffer(GLuint &texture_id, GLuint &RBO_id,GLuint frame_width, GLuint frame_height);
namespace from_thomas {
extern GLuint FBO, texture_id, RBO, WIDTH, HEIGHT;
void create_framebuffer();
void bind_framebuffer();
void unbind_framebuffer();
void rescale_framebuffer(float width, float height);
}
extern bool cp_prepareFBO1(GLuint &colorTextId, GLuint &depthStencilTextId,
                           GLuint &fboId, GLuint frame_width,
                           GLuint frame_height);
...
extern void store_to_clipboard(std::string &str_content);
