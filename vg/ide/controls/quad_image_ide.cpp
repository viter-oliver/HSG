...
void quad_image::ex_init_fun() {
  reg_property_handle(&_img_pt, _img_pt._imge_pos, [this]() {
    ...
    draw_list->AddLine(origin + img_pos0, origin + img_pos1, GRID_COLOR);
    draw_list->AddLine(origin + img_pos1, origin + img_pos2, GRID_COLOR);
    draw_list->AddLine(origin + img_pos2, origin + img_pos3, GRID_COLOR);
    draw_list->AddLine(origin + img_pos0, origin + img_pos3, GRID_COLOR);
