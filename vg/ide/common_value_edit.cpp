...
static char* vtyps[] = { "float", "double", "int", "bool", ":vi2", :_vi3", "3vg:::"vg_vec4" };
static int tpidx = 0;


void common_value_edit::set_dragging( bool be_dragging, control_common_def* pobj, uint16_t page_idx, uint16_t off_idx )
{
...
static const float _minf = -control_common_def::screenw;
static const float _maxf = control_common_def::screenw;
static const double _mind = -control_common_def::screenw;
static const double _maxd = control_common_def::screenw;
     ...
     else if( _type == "
     {
          if( rg == "txt" )// atexture
          {
               * ptxt_idx = pbase;
               ...
               ImGui::Combo( "Texture group list", &ptxt_idx->x, get_texture_group_name, &g_vpacking_texture, igsize );
