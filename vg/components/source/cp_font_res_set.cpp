...
namespace vg
{
	...
	/*cp_font_res_set::cp_font_res_set(font_face_manager& font_mg)
		:_font_mg(font_mg)
	{
	...
	cp_font_res_set::~cp_font_res_set()
	{
	...
	*/
	...
	int font_face_manager::draw_wstring(ps_font_unit& pf_u, GLint fontSize,
                                          cp_vec2& start_pos, cp_vec2& end_pos, 
                                          GLfloat scale, wstring& str_content, 
                                          const cp_vec4& txt_col, float width, 
                                          int omit_rest,bool be_new)
	{
     ...
     int font_face_manager::draw_wstring( ps_font_unit& pf_u,
                                          ...
                                          GLfloat scale,
                                          wstring& str_content,
                                          const cp_vec4& txt_col,
                                          cp_vec2&l_top_edge,
                                          cp_vec2&r_bottom_edge,
                                          float& line_spacing,
                                          bool be_new )
     {
          txt_font_repository* pfrp = nullptr;
