...
cp_feedback::cp_feedback(ps_mtl& pmtl, ps_primrive_object& pprm)
...
cp_feedback::~cp_feedback()
{
	_pmtl = nullptr;
	_pprm = nullptr;
}

bool cp_feedback::get_output_vertex(vector<float>& overtex)
{
