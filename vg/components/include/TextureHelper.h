#ifndef _TEXTURE_HELP_H_
#define _TEXTURE_HELP_H_
#include <iostream>
#include "SOIL2.h"
class TextureHelper
{
public:
	...
	/* �ɹ�����2D�����򷵻���������Id ���򷵻�0                                                                
	*/
	static  GLuint load2DTexture(const char* filename, int& picWidth, int& picHeight, bool mipmap=false)
	{
    int loadChannels;
    GLubyte *imageData = SOIL_load_image(filename, &picWidth, &picHeight,
                                               &loadChannels,
                                      SOIL_LOAD_AUTO);
		if (imageData == NULL)
		{
