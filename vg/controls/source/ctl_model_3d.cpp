...
namespace vg
{
		...
		:ctl_base(), _tri_cnt(0)
	{
		...
		const auto& mtx = g_dic_indep_texture.find("VW_Golf_VII_2013.png");
		_texture = mtx->second;
	...
	void ctl_model_3d::load_mesh_data_2_vertices()
	{
