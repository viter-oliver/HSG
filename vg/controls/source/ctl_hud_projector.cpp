...
namespace vg
{
     ctl_hud_projector::ctl_hud_projector()
     {
          _in_p._sizew = 640;
          _in_p._sizeh = 480;
     ...
     void ctl_hud_projector::release_resource()
     {
          if( _colorTextId )
     ...
     void ctl_hud_projector::link()
     {
          prepareFBO1( _colorTextId, _depthStencilTextId, _fboId, _in_p._sizew, _in_p._sizeh );

     }
     void ctl_hud_projector::draw_frames()
     {
          if( !_fboId )
          {
               return;
     ...
     bool ctl_hud_projector::handle_mouse()
     {
          return true;
     }
