...
namespace vg
{
	...
	void ctl_video::update_pixels(GLubyte* dst, int sz)
	{
     ...
     void ctl_video::update_text_from_image_buff( GLubyte* pimage_buff, int buff_len )
     {
          int tw, th,ch;
