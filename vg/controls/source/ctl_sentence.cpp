...
namespace vg
{
     ctl_sentence::ctl_sentence( ps_font_unit& pfont, wstring wssentence )
          :_pfont_unit(pfont),_wssentence(wssentence )
     {
          _r_bottom_edge = _l_top_edge = _endpos = { 0.f, 0.f };
     }

     ctl_sentence::~ctl_sentence()
     {
     }

     bool ctl_sentence::contains( float posx, float posy )
     {
     ...
     bool ctl_sentence::is_head_of_a_paragraph()
     {
     ...
     bool ctl_sentence::is_same_line()
     {
