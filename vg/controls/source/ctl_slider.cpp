...
namespace vg
{
	...
	bool ctl_slider::read_point_position_file(const char *str)
	{
		auto ij = g_dic_file_chunk.find(str);
		if (ij == g_dic_file_chunk.end())
		{
			return  false;
		}
	...
	void ctl_slider::draw()
	{
		...
		auto& hd_gp_id = _slider_pt._texture_head_index_txt.x;
          ...
          auto& hd_res_gp = *g_vpacking_texture[ hd_gp_id ];
          ...
          packing_txt_cd& hd_text_cd = hd_res_gp.vtexture_coordinates;
		...
		auto& tb_gp_id=_slider_pt._texture_thumb_index_txt.x;
          ...
          auto& tb_re_gp = *g_vpacking_texture[ tb_gp_id ];
          ...
          packing_txt_cd& tb_text_cd = tb_re_gp.vtexture_coordinates;
