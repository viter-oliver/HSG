...
class AFG_EXPORT modeling_3d : public control_base {
  ...
  DEF_STRUCT_WITH_INIT(pty_page, _pty_page, (char, _model_name[FILE_NAME_LEN]),
                       (vec3, _light_ambient_clr), (vec3, _light_diffuse_clr),
                       (vec3, _light_specular_clr), (float, _light_posx, {0.f}),
                       (float, _light_posy, {0.f}), (float, _light_posz, {0.f}),
