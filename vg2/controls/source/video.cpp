...
namespace vg
{
	...
	void video::update_pixels(GLubyte* dst, int sz)
	{
     ...
     void video::update_text_from_image_buff( GLubyte* pimage_buff, int buff_len )
     {
          int tw, th,ch;
